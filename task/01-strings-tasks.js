...
function encodeToRot13(str) {
    ...
    const aphabetROT13 = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm'
    return str.replace(/[A-Za-z]/g, function(currentSymbol) {
    return alphabet.charAt(aphabetROT13.indexOf(currentSymbol));
    });
}
...
function getCardId(value) {
    let shirt = '♣♦♥♠';
    let cardName = 'A234567891JQK';
    return cardName.indexOf(value[0]) + shirt.indexOf(value.slice(-1)) * 13;
}
